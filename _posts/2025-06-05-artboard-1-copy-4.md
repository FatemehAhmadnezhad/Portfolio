...
header:
  teaser: "/assets/images/portfolio/highlight/Artboard 1 copy 4-teaser.png" # مسیر تصویر کوچک برای لیست‌ها
  image: "/assets/images/portfolio/highlight/Artboard 1 copy 4.png"   # مسیر تصویر بزرگ برای خود صفحه نمونه کار
  #-----------------------------------------------------------------------------
