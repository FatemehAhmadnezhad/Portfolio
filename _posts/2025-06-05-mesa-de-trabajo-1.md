...
header:
  teaser: "/assets/images/portfolio/poster/Mesa de trabajo 1-teaser.png" # مسیر تصویر کوچک برای لیست‌ها
  image: "/assets/images/portfolio/poster/Mesa de trabajo 1.png"   # مسیر تصویر بزرگ برای خود صفحه نمونه کار
  #-----------------------------------------------------------------------------
