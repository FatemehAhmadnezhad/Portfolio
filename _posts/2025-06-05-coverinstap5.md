...
header:
  teaser: "/assets/images/portfolio/postcover/coverinstap5-teaser.png" # مسیر تصویر کوچک برای لیست‌ها
  image: "/assets/images/portfolio/postcover/coverinstap5.png"   # مسیر تصویر بزرگ برای خود صفحه نمونه کار
  #-----------------------------------------------------------------------------
